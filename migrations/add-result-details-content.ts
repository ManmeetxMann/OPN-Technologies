...
async function main() {
  database.collection('content').add({
    ...
    lang: 'en',
    resultType: 'Negative',
    details: `The result of your test was NEGATIVE. Your results do not detect SARS-CoV-2, the virus that causes coronavirus disease (also called COVID-19), a respiratory illness. A negative test means that the virus was not present in the sample we collected. Your results suggest you were negative at the time of testing.
