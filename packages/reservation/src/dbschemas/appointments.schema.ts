...
export default Joi.object({
  ...
  agreeCancellationRefund: Joi.boolean().required(),
  hadCovidConfirmedOrSymptoms: Joi.boolean(),
  hadCovidConfirmedOrSymptomsDate: Joi.string().allow(''),
  hadCovidExposer: Joi.boolean(),
  hadCovidExposerDate: Joi.string().allow(''),
