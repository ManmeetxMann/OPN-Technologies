...
abstract class AcuityScheduling {
  ...
  protected async cancelAppointmentOnAcuityService(id: number): Promise<AppointmentAcuityResponse> {
    ...
    LogInfo(`AcuitySchedulingAdapterCancel`, 'Requested', {
      acuityID: id,
    })
    ...
    LogInfo(`AcuitySchedulingAdapterCancel`, 'Success', {
      acuityID: id,
    })
  ...
  protected async updateAppointmentLabelOnAcuityService(
    ...
    LogInfo(`AcuitySchedulingAdapterUpdateLabel`, 'Success', {
      acuityID: id,
      label,
    })
    return this.customFieldsToAppoinment(result)
  ...
  protected async getAppointmentByIdFromAcuityService(
    ...
    LogInfo(`AcuitySchedulingAdapterGetAppointment`, 'Request', {
      acuityID: id,
    })
  ...
  protected async getPackagesFromAcuityService(): Promise<Certificate[]> {
    ...
    LogInfo(`AcuitySchedulingAdapterGetcertificates`, 'Request', {})
  ...
  protected async getAppointmentTypes(): Promise<AppointmentTypes[]> {
    ...
    LogInfo(`AcuitySchedulingAdapterGetAppointmentTypes`, 'Request', {})
  ...
  protected async getCalendars(): Promise<Calendar[]> {
    ...
    LogInfo(`AcuitySchedulingAdapterGetCalendar`, 'Request', {})
    const res = await fetch(apiUrl, {
      method: 'get',
      headers: {
        Authorization: 'Basic ' + userPassBase64,
  ...
  protected async createCouponCodeOnAcuityService(
    ...
    LogInfo(`AcuitySchedulingAdapterCreateCoupon`, 'Success', {
      couponID: couponID,
      email: emailToLockCoupon,
    })
    return result
  ...
  protected async createAppointmentOnAcuityService(
    ...
    LogInfo(`AcuitySchedulingAdapterCreateAppointment`, 'Request', data)
    const res = await fetch(apiUrl, {
      method: 'post',
      headers: {
        Authorization: 'Basic ' + userPassBase64,
    ...
    LogInfo(`AcuitySchedulingAdapterCreateAppointment`, 'Success', {
      email,
      acuityID: result.id,
    })
    return this.customFieldsToAppoinment(result)
  ...
  protected async getAvailabilityDatesList(
    ...
    LogInfo(`AcuitySchedulingAdapterGetAvailbilityDates`, 'Success', {
      appointmentTypeID,
      month,
      calendarID,
      timezone,
  ...
  protected async getAvailableSlotsList(
    ...
    LogInfo(`AcuitySchedulingAdapterGetAvailbilitySlots`, 'Success', {
      appointmentTypeID,
      date,
      calendarID,
      timezone,
