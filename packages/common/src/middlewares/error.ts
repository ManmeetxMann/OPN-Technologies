...
export const handleValidationError: ErrorMiddleware<ValidationError> = (error, req, resp) => {
  console.error(error)
...
export const handleHttpException: ErrorMiddleware<HttpException> = (error, req, resp) => {
