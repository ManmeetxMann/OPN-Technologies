export const prodConfig: Record<string, string | string[] | number | boolean> = {
  ...
  DOMAIN_LOOKUP: 'https://lookup-dot-opn-platform-prod.nn.r.appspot.com/',
  DOMAIN_PASSPORT: 'https://passport-dot-opn-platform-prod.nn.r.appspot.com/',
  DOMAIN_REGISTRY: 'https://registry-dot-opn-platform-prod.nn.r.appspot.com/',
  DOMAIN_RESERVATION: 'https://reservation-dot-opn-platform-prod.nn.r.appspot.com/',
  DOMAIN_CHECKOUT: 'https://checkout-service-dot-opn-platform-prod.nn.r.appspot.com/checkout/',
  DOMAIN_USER: 'https://user-service-dot-opn-platform-prod.nn.r.appspot.com/user/',
