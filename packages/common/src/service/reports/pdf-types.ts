...
export interface TFontFamilyTypes {
  normal?: string | Buffer | Uint8Array | ArrayBuffer
  bold?: string | Buffer | Uint8Array | ArrayBuffer
  italics?: string | Buffer | Uint8Array | ArrayBuffer
  bolditalics?: string | Buffer | Uint8Array | ArrayBuffer
}
...
export type TableCell =
  | unknown // Used when another cell spans over this cell
  | (Content & {
      rowSpan?: number
      colSpan?: number
