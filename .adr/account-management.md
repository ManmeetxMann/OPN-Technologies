...
-----
- Match APIs with wireframe
- Write sequence diagram
- Create tasks in Github for team members
    - Security middleware (with enabled/disabled config)
    - Attestation APIs
    - Access APIs
    

For access and passport:
- Current status should be really fast
- Add validity for an attestation
- Proceed lasts 12hours and expires at 3am
- Caution lasts 24hours
- Stop last 2 week
- Status can be overridden by test-results
- Explore schedule process to deactivate attestation and access
